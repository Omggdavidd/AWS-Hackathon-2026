...
Stack, AWS services and repository layout are **undecided until recorded as ADRs**. The playbook's recommended stack and layout (`SPEC.md` §15) are the proposal Phase 1 evaluates, not decisions. Do not scaffold applications before those ADRs exist.
