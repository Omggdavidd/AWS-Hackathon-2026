...
- 2026-09-12 Loop page shows executed effects (#17); message page behind evidence links (#35, tdare514); Catch me up command and button (#13); dashboard design: shared light/dark palette, state totals, evidence-linked cards, recent progress, responsive navigation and a reduced-motion-aware 3D loop mark (#18); dashboard at a glance: rows instead of cards, one summary line, open-ring mark and palette from the team swatches (#52).
