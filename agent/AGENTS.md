<!-- Open Loops: this file was generated by the AgentCore CLI and documents the agentcore/ config model. The root AGENTS.md still governs; the agent code lives in app/OpenLoopAgent/ (see README.md here). -->
