...
* Good, because the activity feed and the notification bell show the agent checked in while nobody was there, which is the unattended story, for about thirty cents a month.
