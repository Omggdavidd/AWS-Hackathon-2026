...
| `state-lifecycle.png`, `architecture-proposal.png` | Diagrams from the playbook. The submission architecture diagram will live in `docs/architecture/` once the architecture is decided |
